...
public sealed class SetupForm:Form {
    ...
    async void RefreshPlan(object sender,EventArgs args) {
        ...
        try {
            ...
            download.Text=plan.Operations.Count==0?"Your selected release is already installed.":"Download up to "+FormatSize(plan.DownloadBytes)+"  ·  "+(plan.Maps?"Upgraded maps included":"Existing maps kept");
