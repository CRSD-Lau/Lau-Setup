...
public sealed class SetupForm:Form {
    ...
    public SetupForm(Catalog catalog) {
        ...
        bottom.Controls.Add(Label("Release 3.0.5 Lau  •  "+(WineHost.Active?"Wine 11 on Linux":"Windows 10 / 11")+"  •  Existing build 12340 required",10,FontStyle.Regular,muted));grid.Controls.Add(bottom);
    ...
    async void RefreshPlan(object sender,EventArgs args) {
        ...
        try {
            ...
            download.Text=plan.Operations.Count==0?"Your selected release 3.0.5 is already installed.":"Download up to "+FormatSize(plan.DownloadBytes)+"  ·  "+(plan.Maps?"Upgraded maps included":"Existing maps kept");
