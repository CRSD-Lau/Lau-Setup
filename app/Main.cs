...
public sealed class SetupForm:Form {
    ...
    public static string Language(string locale){switch(locale){case "enUS":return "English (US)";case "enGB":return "English (UK)";case "deDE":return "Deutsch";case "frFR":return "Français";case "esES":return "Español (España)";case "esMX":return "Español (México)";case "itIT":return "Italiano";case "koKR":return "한국어";case "ptBR":return "Português (Brasil)";case "ruRU":return "Русский";case "zhCN":return "简体中文";case "zhTW":return "繁體中文";default:return locale;}}
