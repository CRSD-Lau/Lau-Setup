...
public sealed class Downloader {
    ...
    void CheckHost(Uri uri) {
        ...
        if(host=="github.com"&&!(uri.AbsolutePath.StartsWith("/CRSD-Lau/Lau-Setup/releases/download/payload-3.0.4/",StringComparison.Ordinal)||uri.AbsolutePath.StartsWith("/CRSD-Lau/Lau-Setup/releases/download/payload-3.0.5/",StringComparison.Ordinal)||uri.AbsolutePath.StartsWith("/CRSD-Lau/Lau-Setup/releases/download/payload-3.0.6/",StringComparison.Ordinal)))throw new IOException("Unexpected download destination.");
    }
}
}
