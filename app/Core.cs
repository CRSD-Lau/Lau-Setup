...
public sealed class Catalog {
    ...
    public void Validate() {
        if(Version!="3.0.4" || Locales==null || Assets==null || Assets.Count>64 || Locales.Count!=9 || Locales.Distinct().Count()!=9) throw new InvalidDataException("Invalid release catalog.");
    ...
    public static bool ValidDownloadUrl(Part part) { return part.Url=="https://github.com/CRSD-Lau/Lau-Setup/releases/download/payload-3.0.4/"+part.Sha256+".bin"; }
