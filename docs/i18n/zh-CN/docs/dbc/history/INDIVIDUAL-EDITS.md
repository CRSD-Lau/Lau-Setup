...
>
> 由于 Google 请求限额，完整翻译尚未更新。下方原有正文描述的是较早版本的情况。请以最新英文原文为准。 [English](../../../../../dbc/history/INDIVIDUAL-EDITS.md) · [1.1.8](https://github.com/CRSD-Lau/Lau-Setup/releases/tag/v1.1.8)
