...
>
> A tradução completa ainda não foi atualizada devido ao limite de solicitações do Google. O texto existente abaixo corresponde a uma versão anterior. Consulte as informações atuais em inglês. [English](../../../DBC-CHANGELOG.md) · [1.1.8](https://github.com/CRSD-Lau/Lau-Setup/releases/tag/v1.1.8)
