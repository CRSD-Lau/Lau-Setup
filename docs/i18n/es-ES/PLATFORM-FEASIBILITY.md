...
>
> La actualización completa de las guías sigue pendiente por un HTTP 429 de Google. El texto anterior puede estar desactualizado; consulta la fuente inglesa actual y las notas 1.4.0. [English](../../../PLATFORM-FEASIBILITY.md) · [1.4.0](https://github.com/CRSD-Lau/Lau-Setup/releases/tag/v1.4.0)
>
...
> **Evaluación histórica a continuación:** las secciones siguientes sobre 1.0.1/1.1.0 describen el estado evaluado entonces. Para la instalación actual con un ZIP compartido, consulte el aviso de Setup 1.2.0 de arriba.
