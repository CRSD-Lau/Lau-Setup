...
>
> La traducción completa aún no se ha actualizado debido al límite de solicitudes de Google. El texto anterior que aparece debajo corresponde a una versión previa. Consulta la información actual en inglés. [English](../../../CONTRIBUTING.md) · [1.1.8](https://github.com/CRSD-Lau/Lau-Setup/releases/tag/v1.1.8)
