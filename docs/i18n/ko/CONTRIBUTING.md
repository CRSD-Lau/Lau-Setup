...
>
> Google 요청 제한으로 전체 번역이 아직 갱신되지 않았습니다. 아래 기존 본문은 이전 상태를 설명합니다. 최신 정보는 영어 원문을 확인하세요. [English](../../../CONTRIBUTING.md) · [1.1.8](https://github.com/CRSD-Lau/Lau-Setup/releases/tag/v1.1.8)
