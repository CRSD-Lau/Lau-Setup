...
>
> 由於 Google 請求限制，完整翻譯尚未更新。下方原有正文描述的是較早版本的情況。請以最新英文原文為準。 [English](../../../../../dbc/history/INDIVIDUAL-EDITS.md) · [1.1.8](https://github.com/CRSD-Lau/Lau-Setup/releases/tag/v1.1.8)
