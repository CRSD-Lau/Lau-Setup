...
>
> La traduction complète n’a pas encore été actualisée, car Google limite les requêtes. Le texte existant ci-dessous correspond à un état antérieur. Les informations anglaises actuelles font référence. [English](../../../TECHNICAL.md) · [1.1.8](https://github.com/CRSD-Lau/Lau-Setup/releases/tag/v1.1.8)
