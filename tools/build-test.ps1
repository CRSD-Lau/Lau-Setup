...
$shared=@('/nologo','/resource:app\halion-v2-hashes.json,LauSetup.V2.json','/resource:app\halion-v1-hashes.json,LauSetup.V1.json','/r:System.dll','/r:System.Core.dll','/r:System.Web.Extensions.dll','/r:System.Drawing.dll','/r:System.Windows.Forms.dll','/resource:dist\catalog.json,LauSetup.Catalog.json','/resource:dist\baseline.json,LauSetup.Baseline.json','/resource:app\assets\Lau.ico,LauSetup.Icon.ico','app\AssemblyInfo.cs','app\Core.cs','app\HalionTest.cs')
